...
<!-- 투표 항목이 저장된 텍스트 파일의 데이터를 읽어 웹 브라우저에 출력한다. -->
<%
//	D:\kookgi_10gi\JSP\workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\0302_onLinePoll\ => 웹 서비스가 구현되는 실제 경로
//	이클립스는 웹 서비스가 구현되는 실제 경로에 프로젝트 이름의 폴더를 생성한 후 웹 페이지를 실행한다.
//	getRealPath("/")
