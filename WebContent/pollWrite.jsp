...
//	투표 데이터가 넘어왔나(null 이나 공백이 아닌가) 검사한다. => 반드시 null 검사를 먼저한다.
...
//		하나의 jsp 파일에 서버용 스크립트와 클라이언트용 스크립트를 모두 사용한 경우 서버용 스크립트가 먼저 실행되고 난 후 클라이언트용
//		스크립트가 실행된다. => 코딩 순서와는 상관없다.
